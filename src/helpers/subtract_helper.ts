...
function fractionSubtractFraction(value1: string, value2: string) {
...
function fractionSubtractK(value1: string, value2: number) {
  let value1Split = value1.split("/")
  let value1Dividendo = parseInt(value1Split[0])
  let value1Divisor = parseInt(value1Split[1])
...
function kSubtractFraction(value1: number, value2: string) {
  let value2Split = value2.split("/")
  let value2Dividendo = parseInt(value2Split[0])
  let value2Divisor = parseInt(value2Split[1])
...
export function subtract(value1: string | number, value2: string | number) {
  ...
  if (typeof(value1) == "string" && typeof(value2) == "string") {
    result = fractionSubtractFraction(value1, value2)
  } else if (typeof(value1) == "string" && typeof(value2) == "number") {
    result = fractionSubtractK(value1, value2)
  } else if (typeof(value2) == "string" && typeof(value1) == "number") {
    result = kSubtractFraction(value1, value2)
